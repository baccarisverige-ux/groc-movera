...
const GOOGLE_REFERENCE_MAP_STYLES = [
  ...
  { featureType: 'landscape', elementType: 'geometry', stylers: [{ color: '#d8edb5' }] },
  { featureType: 'landscape.man_made', elementType: 'geometry', stylers: [{ color: '#f2f2ef' }] },
  { featureType: 'poi', elementType: 'geometry', stylers: [{ color: '#c1e589' }] },
  { featureType: 'poi.park', elementType: 'geometry', stylers: [{ color: '#aedb6f' }] },
