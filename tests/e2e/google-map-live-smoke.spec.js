...
const liveSmokeEnabled = process.env.MOVERA_LIVE_SMOKE === '1'

test.describe('deployed Google Maps smoke', () => {
  test.skip(!liveSmokeEnabled, 'Runs only against deployed GitHub Pages')
